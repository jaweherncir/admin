...
export default function AddAdmin() {
    ...
    const addAdmin=(e)=>{
      ...
      const passwordError = document.querySelector(".password.error");
        axios({
          method:"POST",
          url:`${process.env.REACT_APP_API_URL}api/admin/ajouter`,
          header:{
        ...
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
          ...
          <div className="container-fluid py-4">
              ...
              <form action="#" className="mb-4">
                ...
                <div className="form-group">
                  <input type="text" className="form-control w-100 mr-3" placeholder="Enter yourpassword"
                ...
                <div className="form-group">
                  <input type="email" className="form-control w-100 mr-3" placeholder="Enter  address"
                ...
                <div className="row">
                  ...
                  <div className="col-6" style={{marginLeft:'20%'}}>
                    <button className="btn btn-info  btn-block" onClick={addAdmin}>Ajouter</button>
                  </div>
                </div>
              </form>  
