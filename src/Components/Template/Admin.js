...
export default function Admin() {
  ...
  useEffect(() => {
    const fetchData = async () => {
        ...
        const response = await fetch(
          ...
          `${process.env.REACT_APP_API_URL}api/admin/`,{mode:'cors'});
  ...
  const deleteUser = (id, name) => {
    if (window.confirm(`Are you sure you want to delete `)) {
      fetch(`${process.env.REACT_APP_API_URL}api/admin/${id}`, {
        method: "DELETE",
        crossDomain: true,
        headers: {
    ...
    <main className="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div className="container-fluid py-4">
            ...
            <div className="col-12">
                ...
                <li className="nav-item d-flex align-items-center">
                    <a className="btn btn-outline-primary btn-sm mb-0 me-3" href='addAdmin' s>Ajouter Admin </a>
                    </li>
                </div>
                <div className="card-body px-0 pt-0 pb-2">
                    ...
                    <table className="table align-items-center mb-0">
                        <thead>
                        <tr>
                            <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nom Admin</th>
                            <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Email Admin</th>
                            <th className="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mot de passe</th>
                            <th className="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date creation</th>
...

                        {
                          ...
                          <tr key={index}>
                            ...
                            <span className="badge badge-sm bg-gradient-secondary">{user.password}</span>
                            </td>
                            <td className="align-middle text-center">
                            <span className="badge badge-sm bg-gradient-info">{user.createdAt}</span>
                            </td>
                            <td className="align-middle text-center">
                            <span className="badge badge-sm bg-gradient-info">{user.updatedAt}</span>
                            </td>
                            <td>
                            <p className="text-xs font-weight-bold mb-0">{user.adresse} </p>
