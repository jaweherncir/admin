    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const response = await fetch(
              ...
              `${process.env.REACT_APP_API_URL}api/admin/user/${id.id}`,{mode:'cors'});
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
          ...
          await axios.put(`${process.env.REACT_APP_API_URL}api/admin/user/${id.id}`,
          {
            name,
            email,
    ...
    <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <li className="nav-item">
          <a className="nav-link  " 
           onClick={()=>window.location='/ClientAdmin'}
       >
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li className="nav-item">
          <a className="nav-link  "
          onClick={()=>window.location='/ReclamationAdmin'}
         >
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div className="form-group">
            <input type="text" className="form-control w-100 mr-3"
        ...
        disabled='false'
          ...
          <div className="form-group">
            <input type="email" className="form-control w-100 mr-3"
          ...
          <div className="form-group">
            <input type="text" className="form-control w-100 mr-3" placeholder="Enter your name"
          ...
          <div className="row">
            ...
            <div className="col-6"style={{marginLeft:'20%'}}>
              <button className="btn btn-info  btn-block"onClick={handleSubmit}>Modifier</button>
            </div>
          </div>
        </form>  
