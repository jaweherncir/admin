  ...
  useEffect(() => {
    const fetchData = async () => {
        ...
        const response = await fetch(
          ...
          `${process.env.REACT_APP_API_URL}api/admin/contact`,{mode:'cors'});
     ...
     <>
          ...
          <div className="card h-100">
            <div className="card-header pb-0 p-3">
              <div className="row">
                <div className="col-md-8 d-flex align-items-center">
                  <h6 className="mb-0" style={{marginLeft:'20%'}}> Information Reclamtion </h6>
                </div>
            ...
            <div className="card-body p-3" >
              <tr>
                <td>
            <li className="list-group-item border-0 ps-0 pt-0 text-sm"><strong className="text-dark">Sujet:</strong> &nbsp; {user.sujet}</li>
            </td>
            </tr>
            <tr>
                <td>
            <li className="list-group-item border-0 ps-0 text-sm" style={{marginTop:10}}><strong className="text-dark">Message:</strong> &nbsp; {user.message}</li><br/>
            </td>
            </tr>
              <hr className="horizontal gray-light my-4" />
            
              <ul className="list-group" style={{marginTop:-30}}>
                <li className="list-group-item border-0 ps-0 pt-0 text-sm"><strong className="text-dark">Nom Client:</strong> &nbsp; {user.name}</li>
   
                <li className="list-group-item border-0 ps-0 text-sm"><strong className="text-dark">Email:</strong> &nbsp;  {user.email}</li>
                <li className="list-group-item border-0 ps-0 text-sm"><strong className="text-dark">Lacalisation:</strong> &nbsp; Tunise</li>
                <li className="list-group-item border-0 ps-0 text-sm"><strong className="text-dark">Date:</strong> &nbsp; {user.createdAt}</li>
