...
export default function UpdateAdmin() {
    ...
    useEffect(() => {
      const fetchData = async () => {
          ...
          const response = await fetch(
            ...
            `${process.env.REACT_APP_API_URL}api/admin/${id.id}`,{mode:'cors'});
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      await axios.put(`${process.env.REACT_APP_API_URL}api/admin/${id.id}`,
      {
        nom,
        email,
        password,
...
<div class="g-sidenav-show  bg-gray-100">
    ...
    <div>
      <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <li className="nav-item">
          <a className="nav-link  "  onClick={()=>window.location='/Admin'}>
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <form action="#" className="mb-4">
          ...
          <div className="form-group">
            <input type="nom" className="form-control w-100 mr-3" placeholder="Enter your name"
          ...
          <div className="form-group">
            <input type="test" className="form-control w-100 mr-3" placeholder="Enter  address"
